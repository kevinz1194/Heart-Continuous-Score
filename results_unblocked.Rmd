...
<!-- 1. Set up continuous dataset (Line 34) -->
<!-- 2. Comparison of training and testing datasets (Line 81) -->
<!-- 3. Find missing % at listing (Line 204) -->
<!-- 4. Impute values into unblocked dataset (Line 233) -->
<!-- 5. Make predictions on unblocked dataset and calculate Harrell's c, Brier score (Line 342) -->
<!-- 6. Create AUC curves (Line 471) -->
<!-- 7. Cox PH with US-CRS predictors on unblocked (Line 500) -->
<!-- 8. Make prediction figures on unblocked dataset (Line 515) -->
...
# 7. Cox PH with US-CRS predictors on unblocked

```{r, warning=F, echo=F, message=F, comment=NA}
concordance(coxph(Surv(t_start, t_stop, death) ~ 
