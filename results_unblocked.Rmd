...
<!-- 1. Set up continuous dataset (Line 33) -->
<!-- 2. Comparison of training and testing datasets (Line 80) -->
<!-- 3. Find missing % at listing (Line 192) -->
<!-- 4. Impute values into unblocked dataset (Line 221) -->
<!-- 5. Make predictions on unblocked dataset and calculate discrimination measurements (Line 330) -->
<!-- 6. Cox PH with US-CRS predictors on unblocked (Line 457) -->
<!-- 7. Make prediction figures on unblocked dataset (Line 472) -->
...
df_table1 %>%
  ...
  tbl_summary(by = train_test, 
              ...
              label = c(age ~ 'Age at Listing, mean (SD), y',
                        ...
                        ECMO ~ 'ECMO',
                        temp_surg_LVAD ~ 'Temporary Surgical LVAD',
                        BiVAD_no_discharge ~ 'BiVAD, No Discharge')) %>%
...
# 6. Cox PH with US-CRS predictors on unblocked
...
# 7. Make prediction figures on unblocked dataset
