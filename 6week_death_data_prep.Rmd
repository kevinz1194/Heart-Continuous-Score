...
<!-- 1. Set up original modified dataset (Line 38) -->
<!-- 2. Merge with status justification datasets and create variables (Line 156) -->
<!-- 3. Merge with cand_thor dataset and create create time-related variables (Line 484) -->
<!-- 4. Set up remaining clinical variables (Line 738) -->
<!-- 5. Add in BNP type and fix sodium (Line 844) -->
<!-- 6. Create intervals (Line 864) -->
<!-- 7. Add memory variables (Line 1120) -->
<!-- 8. Death in 6 weeks (Line 1262) -->
<!-- 9. Impute variables (Line 1298) -->
<!-- 10. Generate new clinical variables (Line 1461) -->
<!-- 11. Sample checks between blocked and unblocked (Line 1510) -->
