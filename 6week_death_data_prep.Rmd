...
<!-- 7. Add memory variables (Line 1195) -->
<!-- 8. Death in 6 weeks (Line 1337) -->
<!-- 9. Count missingness (Line 1373) -->
<!-- 10. Impute variables (Line 1446) -->
<!-- 11. Generate new clinical variables (Line 1593) -->
<!-- 12. Histograms of variables (Line 1642) -->
<!-- 13. Sample checks between blocked and unblocked (Line 1723) -->
