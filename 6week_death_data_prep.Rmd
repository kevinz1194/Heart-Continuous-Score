...
<!-- 3. Merge with cand_thor dataset and create create time-related variables (Line 484) -->
<!-- 4. Set up remaining clinical variables (Line 735) -->
<!-- 5. Create intervals (Line 841) -->
<!-- 6. Add memory variables (Line 1072) -->
<!-- 7. Death in 6 weeks (Line 1220) -->
<!-- 8. Impute variables (Line 1256) -->
<!-- 9. Generate new clinical variables (Line 1424) -->
<!-- 10. Sample checks between blocked and unblocked (Line 1467) -->
...
df_intervals <- data.frame(lapply(df_intervals, trimws), stringsAsFactors = F) ### Clean up string variables
...
## Convert exception to exception ever
...
df <- df %>% filter(PX_ID %in% sample_ids)
df_intervals <- df_intervals %>% filter(PX_ID %in% sample_ids)
```
