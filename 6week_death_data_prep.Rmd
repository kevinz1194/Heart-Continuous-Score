...
<!-- 1. Set up original modified dataset (Line 33) -->
<!-- 2. Merge with status justification datasets and create variables (Line 150) -->
<!-- 3. Merge with cand_thor dataset and create create time-related variables (Line 482) -->
<!-- 4. Set up remaining clinical variables (Line 731) -->
<!-- 5. Create intervals (Line 837) -->
<!-- 6. Add memory variables (Line 1067) -->
<!-- 7. Death in 6 weeks (Line 1223) -->
<!-- 8. Impute variables (Line 1251) -->
<!-- 9. Generate new clinical variables (Line 1438) -->
...
```{r, warning=F, comment=NA, message=F}
duplicate_counts <- floor(df$time / 14)
...
df_intervals <- df_intervals %>% filter(interval_start <= max_time)
```
