...
knitr::opts_knit$set(root.dir = 'C:/Users/kevin/OneDrive - The University of Chicago/Pritzker/R/Heart-Continuous-Score')
```
...
df <- df %>% 
  mutate(dobutamine = case_when(
    ...
    # ExtInoMulDobutamine.y == 1 | InoMulDobutamine.y == 1 |
...
df <- df %>% 
  mutate(milrinone = case_when(
    ...
    # ExtInoMulMilrinone.y == 1 | InoMulMilrinone.y == 1 |
...
df <- df %>% 
  mutate(epinephrine = case_when(
    ...
    # ExtInoMulEpinephrine.y == 1 | InoMulEpinephrine.y == 1 |
