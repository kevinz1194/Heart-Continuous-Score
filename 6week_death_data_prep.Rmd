...
<!-- 3. Merge with cand_thor dataset and create create time-related variables (Line 486) -->
<!-- 4. Set up remaining clinical variables (Line 740) -->
<!-- 5. Add in BNP type and fix sodium (Line 846) -->
<!-- 6. Create intervals (Line 867) -->
<!-- 7. Add memory variables (Line 1123) -->
<!-- 8. Death in 6 weeks (Line 1265) -->
<!-- 9. Count missingness (Line 1301) -->
<!-- 10. Impute variables (Line 1375) -->
<!-- 11. Generate new clinical variables (Line 1522) -->
<!-- 12. Histograms of variables (Line 1571) -->
<!-- 13. Sample checks between blocked and unblocked (Line 1652) -->
