...
<!-- 5. Add in BNP type and fix sodium (Line ) -->
<!-- 6. Create intervals (Line ) -->
<!-- 7. Add memory variables (Line ) -->
<!-- 8. Death in 6 weeks (Line ) -->
<!-- 9. Impute variables (Line ) -->
<!-- 10. Generate new clinical variables (Line ) -->
<!-- 11. Confirm last dates from cand_thor (Line ) -->
...
# 11. Confirm last dates from cand_thor
