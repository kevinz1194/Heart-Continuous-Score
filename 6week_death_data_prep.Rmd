...
<!-- 1. Set up original modified dataset (Line 39) -->
<!-- 2. Merge with status justification datasets and create variables (Line 157) -->
<!-- 3. Merge with cand_thor dataset and create create time-related variables (Line 485) -->
<!-- 4. Set up remaining clinical variables (Line 736) -->
<!-- 5. Add in BNP type and fix sodium (Line 842) -->
<!-- 6. Create intervals (Line 862) -->
<!-- 7. Add memory variables (Line 1118) -->
<!-- 8. Death in 6 weeks (Line 1260) -->
<!-- 9. Impute variables (Line 1296) -->
<!-- 10. Generate new clinical variables (Line 1459) -->
<!-- 11. Confirm last active date from cand_thor (Line 1507) -->
<!-- 12. Sample checks between blocked and unblocked (Line ) -->
...
# 11. Confirm last active date from cand_thor
...
# 12. Sample checks between blocked and unblocked
