...
<!-- 4. Obtain machine learning model results (Line 1245) -->
<!-- 5. Make predictions on test dataset (Line 1303) -->
<!-- 6. Create AUC curves (Line 1344) -->
<!-- 7. Variable importance plots from gradient-boosted models (Line 1426) -->
<!-- 8. Create calibration plot in test dataset (Line 1487) -->
<!-- 9. Create facet plot of 50 point score at initial listing (Line 1535) -->
...
colnames(DMat_test) <- c('(Intercept)', 'Interval_1', 'Interval_2', 'Interval_3', 'Interval_4',
                         ...
                         'Bilirubin', 'eGFR', 'Sodium', 'AST100', 'BNP100', 'BUN10', 'BNP_NT_Pro', 'INR',
...
colnames(DMat_test_all) <- c('(Intercept)', 'Interval_1', 'Interval_2', 'Interval_3', 'Interval_4',
                             ...
                             'Heart_Rate10', 'Cardiac_Output', 'Central_Venous_Pressure',
                             'Arterial_Lactate', 'Hemoglobin', 'Albumin',
                             'Bilirubin', 'eGFR', 'Sodium', 'AST100', 'BNP100', 'BNP_NT_Pro', 'BUN10', 'INR',
                             'Life_Arrhythmia1', 'BiVAD_NoDischarge1', 'TempSurgery_LVAD1', 'Other_DurableMCSD1',
                             'MCSD_Malfunction1', 'VTach_Fib1', 'Perc_LVAD1', 'MCSD_Hemolysis1', 'MCSD_Rhf1',
                             'MCSD_DeviceInfection1', 'MCSD_Bleed1', 'MCSD_Aortic_Insufficent1', 'Angina1',
...
df_coefplot$french_stderr[df_coefplot$var == 'short_MCS_ever'] <- 
  summary(model1)$coefficients['short_MCS_French', 'Std. Error']
...
df_coefplot %>%
  ...
  scale_y_discrete(labels=c('Durable LVAD', expression('Sodium'^'b'), 'Albumin', 
                            expression('PAPi'^'c'), 'CPO', 'Log BNP', 
                            'NT-proBNP', expression('eGFR'^'b'), 'Log Bilirubin', 
                            expression('Short-Term MCS'^'a'))) +
  scale_colour_manual(name='Model',
                      breaks = c('US', 'French'),
                      values = c('#880d1e', '#3f88c5'), 
                      labels = c('US-CRS', 'French-CRS')) + 
  theme_bw() +
...
df_intervals %>%
  ...
  xlab('US-CRS Initial Score') + ylab('Count') +
  theme_bw() + 
    theme(
    panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
