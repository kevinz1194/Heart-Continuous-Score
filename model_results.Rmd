...
<!-- 1. Set up dataset with generated cardiac variables (Line 41) -->
<!-- 2. Set up matrices for predictions (Line 154) -->
...
<!-- 8. Variable importance plots from gradient-boosted models (Line 1951) -->
<!-- 9. Create calibration plot in test dataset (Line 2012) -->
<!-- 10. Create facet plot of 50 point score at initial listing (Line 2069) -->
<!-- 11. Examine gender and race differences in prediction (Line 2099) -->
<!-- 12. Check for informative censoring (Line 2257) -->
<!-- 13. Examine a model with center random effects (Line 2292) -->
<!-- 14. Examine sensitivity and specificity at certain cut points (Line 2310) -->
<!-- 15. Examine model performance based on temporal split (Line 2358) -->
<!-- 16. Coefficient plot for 2 week outcome (Line 2427) -->
...
pROC::coords(sixstatus_auc, x=1, input='threshold')
pROC::coords(sixstatus_auc, x=2, input='threshold')
pROC::coords(sixstatus_auc, x=3, input='threshold')
pROC::coords(sixstatus_auc, x=4, input='threshold')
pROC::coords(sixstatus_auc, x=5, input='threshold')
pROC::coords(sixstatus_auc, x=6, input='threshold')

pROC::coords(french_auc, x=0.080, input='sensitivity')
pROC::coords(french_auc, x=0.284, input='sensitivity')
pROC::coords(french_auc, x=0.363, input='sensitivity')
pROC::coords(french_auc, x=0.805, input='sensitivity')
pROC::coords(french_auc, x=0.839, input='sensitivity')

pROC::coords(french_auc, x=0.990, input='specificity')
pROC::coords(french_auc, x=0.923, input='specificity')
pROC::coords(french_auc, x=0.861, input='specificity')
pROC::coords(french_auc, x=0.304, input='specificity')
pROC::coords(french_auc, x=0.263, input='specificity')


pROC::coords(us_auc, x=0.080, input='sensitivity')
pROC::coords(us_auc, x=0.284, input='sensitivity')
pROC::coords(us_auc, x=0.363, input='sensitivity')
pROC::coords(us_auc, x=0.805, input='sensitivity')
pROC::coords(us_auc, x=0.839, input='sensitivity')

pROC::coords(us_auc, x=0.990, input='specificity')
pROC::coords(us_auc, x=0.923, input='specificity')
pROC::coords(us_auc, x=0.861, input='specificity')
pROC::coords(us_auc, x=0.304, input='specificity')
pROC::coords(us_auc, x=0.263, input='specificity')
```
