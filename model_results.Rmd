...
<!-- 8. Variable importance plots from gradient-boosted models (Line 2094) -->
<!-- 9. Create calibration plot in test dataset (Line 2155) -->
<!-- 10. Create facet plot of 50 point score at initial listing (Line 2264) -->
<!-- 11. Examine gender and race differences in prediction (Line 2294) -->
<!-- 12. Check for informative censoring (Line 2647) -->
<!-- 13. Examine a model with center random effects (Line 2680) -->
<!-- 14. Examine sensitivity and specificity at certain cut points (Line 2701) -->
<!-- 15. Examine model performance based on temporal split (Line 2747) -->
<!-- 16. Coefficient plot for 2 week outcome (Line 2815) -->
