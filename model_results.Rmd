...
```{r, echo=F, warning=F, message=F, comment=NA}
df_coefplot <- data.frame(
  'var' = c('Short-Term MCS', 'Short-Term MCS', 'Log Bilirubin', 'Log Bilirubin',
            'eGFR', 'eGFR', 'Log BNP, Regular BNP', 'Log BNP, Regular BNP',
            'Log BNP, NT-proBNP', 'Log BNP, NT-proBNP', 'Albumin', 'Albumin',
            'Sodium', 'Sodium', 'Durable LVAD', 'Durable LVAD'),
...
df_coefplot$est[df_coefplot$var == 'Albumin' & df_coefplot$model == '2'] <- -0.774396
df_coefplot$stderr[df_coefplot$var == 'Albumin' & df_coefplot$model == '2'] <- 0.059960
df_coefplot$est[df_coefplot$var == 'Log Bilirubin' & df_coefplot$model == '2'] <- 0.667732
df_coefplot$stderr[df_coefplot$var == 'Log Bilirubin' & df_coefplot$model == '2'] <- 0.096074
df_coefplot$est[df_coefplot$var == 'eGFR' & df_coefplot$model == '2'] <- -0.011208
df_coefplot$stderr[df_coefplot$var == 'eGFR' & df_coefplot$model == '2'] <- 0.001561
df_coefplot$est[df_coefplot$var == 'Sodium' & df_coefplot$model == '2'] <- -0.086470
df_coefplot$stderr[df_coefplot$var == 'Sodium' & df_coefplot$model == '2'] <- 0.009662
df_coefplot$est[df_coefplot$var == 'Durable LVAD' & df_coefplot$model == '2'] <- -0.393763
df_coefplot$stderr[df_coefplot$var == 'Durable LVAD' & df_coefplot$model == '2'] <- 0.104724
df_coefplot$est[df_coefplot$var == 'Short-Term MCS' & df_coefplot$model == '2'] <- 1.227926
df_coefplot$stderr[df_coefplot$var == 'Short-Term MCS' & df_coefplot$model == '2'] <- 0.197645
df_coefplot$est[df_coefplot$var == 'Log BNP, Regular BNP' & df_coefplot$model == '2'] <- 0.464056
df_coefplot$stderr[df_coefplot$var == 'Log BNP, Regular BNP' & df_coefplot$model == '2'] <- 0.051574
df_coefplot$est[df_coefplot$var == 'Log BNP, NT-proBNP' & df_coefplot$model == '2'] <- 0.239965
df_coefplot$stderr[df_coefplot$var == 'Log BNP, NT-proBNP' & df_coefplot$model == '2'] <- 0.033546


df_coefplot$est[df_coefplot$var == 'Albumin' & df_coefplot$model == '6'] <- -0.6611378
df_coefplot$stderr[df_coefplot$var == 'Albumin' & df_coefplot$model == '6'] <- 0.0358904
df_coefplot$est[df_coefplot$var == 'Log Bilirubin' & df_coefplot$model == '6'] <- 0.6188804
df_coefplot$stderr[df_coefplot$var == 'Log Bilirubin' & df_coefplot$model == '6'] <- 0.0611198
df_coefplot$est[df_coefplot$var == 'eGFR' & df_coefplot$model == '6'] <- -0.0122161
df_coefplot$stderr[df_coefplot$var == 'eGFR' & df_coefplot$model == '6'] <- 0.0009163
df_coefplot$est[df_coefplot$var == 'Sodium' & df_coefplot$model == '6'] <- -0.0762762 
df_coefplot$stderr[df_coefplot$var == 'Sodium' & df_coefplot$model == '6'] <- 0.0057679
df_coefplot$est[df_coefplot$var == 'Durable LVAD' & df_coefplot$model == '6'] <- -0.3698616
df_coefplot$stderr[df_coefplot$var == 'Durable LVAD' & df_coefplot$model == '6'] <- 0.0588071
df_coefplot$est[df_coefplot$var == 'Short-Term MCS' & df_coefplot$model == '6'] <- 1.0286849
df_coefplot$stderr[df_coefplot$var == 'Short-Term MCS' & df_coefplot$model == '6'] <- 0.1373539
df_coefplot$est[df_coefplot$var == 'Log BNP, Regular BNP' & df_coefplot$model == '6'] <- 0.4289972
df_coefplot$stderr[df_coefplot$var == 'Log BNP, Regular BNP' & df_coefplot$model == '6'] <- 0.0303136
df_coefplot$est[df_coefplot$var == 'Log BNP, NT-proBNP' & df_coefplot$model == '6'] <- 0.2232971
df_coefplot$stderr[df_coefplot$var == 'Log BNP, NT-proBNP' & df_coefplot$model == '6'] <- 0.0193497


df_coefplot$est[df_coefplot$var == 'eGFR' & df_coefplot$model == '2'] <- 
  df_coefplot$est[df_coefplot$var == 'eGFR' & df_coefplot$model == '2'] * 10
df_coefplot$est[df_coefplot$var == 'Sodium' & df_coefplot$model == '2'] <- 
  df_coefplot$est[df_coefplot$var == 'Sodium' & df_coefplot$model == '2'] * 10
df_coefplot$stderr[df_coefplot$var == 'eGFR' & df_coefplot$model == '2'] <- 
  df_coefplot$stderr[df_coefplot$var == 'eGFR' & df_coefplot$model == '2'] * 10
df_coefplot$stderr[df_coefplot$var == 'Sodium' & df_coefplot$model == '2'] <- 
  df_coefplot$stderr[df_coefplot$var == 'Sodium' & df_coefplot$model == '2'] * 10

df_coefplot$est[df_coefplot$var == 'eGFR' & df_coefplot$model == '6'] <- 
  df_coefplot$est[df_coefplot$var == 'eGFR' & df_coefplot$model == '6'] * 10
df_coefplot$est[df_coefplot$var == 'Sodium' & df_coefplot$model == '6'] <- 
  df_coefplot$est[df_coefplot$var == 'Sodium' & df_coefplot$model == '6'] * 10
df_coefplot$stderr[df_coefplot$var == 'eGFR' & df_coefplot$model == '6'] <- 
  df_coefplot$stderr[df_coefplot$var == 'eGFR' & df_coefplot$model == '6'] * 10
df_coefplot$stderr[df_coefplot$var == 'Sodium' & df_coefplot$model == '6'] <- 
  df_coefplot$stderr[df_coefplot$var == 'Sodium' & df_coefplot$model == '6'] * 10
