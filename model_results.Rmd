...
<!-- 11. Examine gender and race differences in prediction (Line 2101) -->
<!-- 12. Check for informative censoring (Line 2259) -->
<!-- 13. Examine a model with center random effects (Line 2295) -->
...
### Coefficient plot of results without hemodynamics (eFigure 1)
