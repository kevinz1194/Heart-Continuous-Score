...
<!-- 3. Run selected logistic regression models and create coefficient plots (Line 586) -->
<!-- 4. Obtain machine learning model results (Line 990) -->
<!-- 5. Make predictions on test dataset (Line 1048) -->
<!-- 6. Create AUC curves (Line 1089) -->
<!-- 7. Variable importance plots from gradient-boosted models/eSupplement 7 (Line 1160) -->
...
### ROC curve for models with all memory variables (eSupplement 5)
...
# 7. Variable importance plots from gradient-boosted models/eSupplement 7
