...
<!-- 3. Run selected logistic regression models and create coefficient plots (Line 614) -->
<!-- 4. Run sensitivity logistic regression models (Line 1698) -->
<!-- 5. Obtain machine learning model results (Line 1776) -->
<!-- 6. Make predictions on test dataset (Line 1838) -->
<!-- 7. Create AUC curves (Line 1899) -->
<!-- 8. Variable importance plots from gradient-boosted models (Line 1959) -->
<!-- 9. Create calibration plot in test dataset (Line 2020) -->
<!-- 10. Create facet plot of 50 point score at initial listing (Line 2078) -->
<!-- 11. Examine gender and race differences in prediction (Line 2108) -->
<!-- 12. Check for informative censoring (Line 2266) -->
<!-- 13. Examine sensitivity and specificity at certain cut points (Line 2300) -->
<!-- 14. Examine model performance based on temporal split (Line 2347) -->
<!-- 15. Coefficient plot for 2 week outcome (Line 2415) -->
...
model_french_old_results <- as.data.frame(lmtest::coeftest(model_french_old, vcov=vcovCL, cluster=~CenterId)[,])
...
model_french_new_results <- as.data.frame(lmtest::coeftest(model_french_new, vcov=vcovCL, cluster=~CenterId)[,])
...
model_PCWP_results <- as.data.frame(lmtest::coeftest(model_PCWP, vcov=vcovCL, cluster=~CenterId)[,])
...
model_CPO_API_results <- as.data.frame(lmtest::coeftest(model_CPO_API, vcov=vcovCL, cluster=~CenterId)[,])
...
model_CPO_results <- as.data.frame(lmtest::coeftest(model_CPO, vcov=vcovCL, cluster=~CenterId)[,])
...
model_API_results <- as.data.frame(lmtest::coeftest(model_API, vcov=vcovCL, cluster=~CenterId)[,])
...
model_PAPI_CPO_results <- as.data.frame(lmtest::coeftest(model_PAPI_CPO, vcov=vcovCL, cluster=~CenterId)[,])
...
model_PAPI_results <- as.data.frame(lmtest::coeftest(model_PAPI, vcov=vcovCL, cluster=~CenterId)[,])
...
model_CPO_PAPI_AST_API_results <- as.data.frame(lmtest::coeftest(model_CPO_PAPI_AST_API, vcov=vcovCL, cluster=~CenterId)[,])
...
model_CPO_PAPI_API_results <- as.data.frame(lmtest::coeftest(model_CPO_PAPI_API, vcov=vcovCL, cluster=~CenterId)[,])
...
model_CPO_PAPI_AST_results <- as.data.frame(lmtest::coeftest(model_CPO_PAPI_AST, vcov=vcovCL, cluster=~CenterId)[,])
...
model_no_hemo_results <- as.data.frame(lmtest::coeftest(model_no_hemo, vcov=vcovCL, cluster=~CenterId)[,])
...
model_final_results <- as.data.frame(lmtest::coeftest(model_final, vcov=vcovCL, cluster=~CenterId)[,])
...
model_final_hemo_results <- as.data.frame(lmtest::coeftest(model_final_hemo, vcov=vcovCL, cluster=~CenterId)[,])
...
df_coefplot <- as.data.frame(
  lmtest::coeftest(model_final, vcov=vcovCL, cluster=~CenterId)[,])[ ,c('Estimate', 'Std. Error')]
...
df_coefplot$french_stderr[df_coefplot$var == 'short_MCS_ever'] <- 
  as.data.frame(lmtest::coeftest(model_french_new, vcov=vcovCL, cluster=~CenterId)[,])['short_MCS_French_new','Std. Error']
df_coefplot$french_stderr[df_coefplot$var == 'log(bilirubin + 1)'] <- 
  as.data.frame(lmtest::coeftest(model_french_new, vcov=vcovCL, cluster=~CenterId)[,])['log(bilirubin + 1)','Std. Error']
df_coefplot$french_stderr[df_coefplot$var == 'eGFR'] <- 
  as.data.frame(lmtest::coeftest(model_french_new, vcov=vcovCL, cluster=~CenterId)[,])['eGFR','Std. Error']

df_coefplot$french_stderr[df_coefplot$var == 'log(BNP + 1):BNP_NT_Pro0'] <- 
  as.data.frame(lmtest::coeftest(model_french_new, vcov=vcovCL, cluster=~CenterId)[,])['log(BNP + 1):BNP_NT_Pro0','Std. Error']
df_coefplot$french_stderr[df_coefplot$var == 'log(BNP + 1):BNP_NT_Pro1'] <- 
  as.data.frame(lmtest::coeftest(model_french_new, vcov=vcovCL, cluster=~CenterId)[,])['log(BNP + 1):BNP_NT_Pro1','Std. Error']
...
```{r, warning=F, echo=F, message=F, comment=NA, fig.align='center', fig.height=8, fig.width=8}
df_coefplot <- as.data.frame(
  lmtest::coeftest(model_final_hemo, vcov=vcovCL, cluster=~CenterId)[,])[ ,c('Estimate', 'Std. Error')]
df_coefplot$var <- rownames(df_coefplot)
rownames(df_coefplot) <- NULL
colnames(df_coefplot) <- c('us_est', 'us_stderr', 'var')
...
df_coefplot %>%
  ...
  geom_errorbarh(aes(xmin = lower, xmax = upper), position = position_dodge(width = 0.7)) +
  geom_vline(xintercept = 0, lty = 2, color = '#880d1e', linewidth = 0.05) +
  xlab('Log-Odds Effect for 6-Week Waitlist Mortality') + xlim(-1.25, 1.25) +
  scale_y_discrete(labels=c('Durable LVAD', expression('Sodium'^'b'), 'Albumin', 
...
model_final_BP_results <- as.data.frame(
  lmtest::coeftest(model_final_BP, vcov=vcovCL, cluster=~CenterId)[,])[ ,c('Estimate', 'Pr(>|z|)')]
...
model_hemo_BP_results <- as.data.frame(
  lmtest::coeftest(model_hemo_BP, vcov=vcovCL, cluster=~CenterId)[,])[ ,c('Estimate', 'Pr(>|z|)')]
...
# 13. Examine sensitivity and specificity at certain cut points
...
pROC::ci.coords(sixstatus_auc, x=6, input='threshold')

pROC::ci.coords(french_auc, x=0.080, input='sensitivity')
pROC::ci.coords(french_auc, x=0.284, input='sensitivity')
pROC::ci.coords(french_auc, x=0.363, input='sensitivity')
pROC::ci.coords(french_auc, x=0.805, input='sensitivity')
pROC::ci.coords(french_auc, x=0.839, input='sensitivity')

pROC::ci.coords(french_auc, x=0.990, input='specificity')
pROC::ci.coords(french_auc, x=0.923, input='specificity')
pROC::ci.coords(french_auc, x=0.861, input='specificity')
pROC::ci.coords(french_auc, x=0.304, input='specificity')
pROC::ci.coords(french_auc, x=0.263, input='specificity')


pROC::ci.coords(us_auc, x=0.080, input='sensitivity')
pROC::ci.coords(us_auc, x=0.284, input='sensitivity')
pROC::ci.coords(us_auc, x=0.363, input='sensitivity')
pROC::ci.coords(us_auc, x=0.805, input='sensitivity')
pROC::ci.coords(us_auc, x=0.839, input='sensitivity')

pROC::ci.coords(us_auc, x=0.990, input='specificity')
pROC::ci.coords(us_auc, x=0.923, input='specificity')
pROC::ci.coords(us_auc, x=0.861, input='specificity')
pROC::ci.coords(us_auc, x=0.304, input='specificity')
pROC::ci.coords(us_auc, x=0.263, input='specificity')
```
...
# 14. Examine model performance based on temporal split
...
# 15. Coefficient plot for 2 week outcome
...
```{r, echo=F, warning=F, message=F, comment=NA}
df_coefplot <- as.data.frame(
  lmtest::coeftest(model_final_2week, vcov=vcovCL, cluster=~CenterId)[,])[ ,c('Estimate', 'Std. Error')]
df_coefplot$var <- rownames(df_coefplot)
rownames(df_coefplot) <- NULL
...
df_coefplot$six_stderr[df_coefplot$var == 'short_MCS_ever'] <- 
  as.data.frame(lmtest::coeftest(model_final, vcov=vcovCL, cluster=~CenterId)[,])['short_MCS_ever','Std. Error']
df_coefplot$six_stderr[df_coefplot$var == 'log(bilirubin + 1)'] <- 
  as.data.frame(lmtest::coeftest(model_final, vcov=vcovCL, cluster=~CenterId)[,])['log(bilirubin + 1)','Std. Error']
df_coefplot$six_stderr[df_coefplot$var == 'eGFR'] <- 
  as.data.frame(lmtest::coeftest(model_final, vcov=vcovCL, cluster=~CenterId)[,])['eGFR','Std. Error']
df_coefplot$six_stderr[df_coefplot$var == 'sodium'] <- 
  as.data.frame(lmtest::coeftest(model_final, vcov=vcovCL, cluster=~CenterId)[,])['sodium','Std. Error']
df_coefplot$six_stderr[df_coefplot$var == 'albumin'] <- 
  as.data.frame(lmtest::coeftest(model_final, vcov=vcovCL, cluster=~CenterId)[,])['albumin','Std. Error']
df_coefplot$six_stderr[df_coefplot$var == 'LVAD1'] <- 
  as.data.frame(lmtest::coeftest(model_final, vcov=vcovCL, cluster=~CenterId)[,])['LVAD1','Std. Error']
df_coefplot$six_stderr[df_coefplot$var == 'log(BNP + 1):BNP_NT_Pro0'] <- 
  as.data.frame(lmtest::coeftest(model_final, vcov=vcovCL, cluster=~CenterId)[,])['log(BNP + 1):BNP_NT_Pro0','Std. Error']
df_coefplot$six_stderr[df_coefplot$var == 'log(BNP + 1):BNP_NT_Pro1'] <- 
  as.data.frame(lmtest::coeftest(model_final, vcov=vcovCL, cluster=~CenterId)[,])['log(BNP + 1):BNP_NT_Pro1','Std. Error']
