...
<!-- 2. Set up matrices for predictions (Line 149) -->
<!-- 3. Run selected logistic regression models and create coefficient plots (Line 605) -->
<!-- 4. Run sensitivity logistic regression models (Line 1536) -->
<!-- 5. Obtain machine learning model results (Line 1612) -->
<!-- 6. Make predictions on test dataset (Line 1674) -->
<!-- 7. Create AUC curves (Line 1728) -->
<!-- 8. Variable importance plots from gradient-boosted models (Line 1784) -->
<!-- 9. Create calibration plot in test dataset (Line 1845) -->
<!-- 10. Create facet plot of 50 point score at initial listing (Line 1902) -->
