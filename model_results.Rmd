...
<!-- 4. Run sensitivity logistic regression models (Line 1550) -->
<!-- 5. Obtain machine learning model results (Line 1626) -->
<!-- 6. Make predictions on test dataset (Line 1688) -->
<!-- 7. Create AUC curves (Line 1749) -->
<!-- 8. Variable importance plots from gradient-boosted models (Line 1805) -->
<!-- 9. Create calibration plot in test dataset (Line 1866) -->
<!-- 10. Create facet plot of 50 point score at initial listing (Line 1923) -->
<!-- 11. Examine gender and race differences in prediction (Line 1955) -->
