...
<!-- 7. Variable importance plots from gradient-boosted models (Line 1404) -->
<!-- 8. Create calibration plot in test dataset (Line 1465) -->
<!-- 9. Create facet plot of 50 point score at initial listing (Line 1513) -->
...
pROC::roc(df_intervals_test_model2$death6week ~ model2_predict, direction='<',
          plot=T, print.auc=T, ci=T, ci.type = 'no',
...
legend('bottomright', cex = 1.1, xpd = T,
      legend = c('6-Status', 
                 'Elastic Net',
