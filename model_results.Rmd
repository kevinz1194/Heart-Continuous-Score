...
<!-- 1. Set up dataset with generated cardiac variables (Line 36) -->
<!-- 2. Set up matrices for predictions (Line 150) -->
<!-- 3. Run selected logistic regression models and create coefficient plots (Line 606) -->
