...
<!-- 4. Run sensitivity logistic regression models (Line 1530) -->
<!-- 5. Obtain machine learning model results (Line 1606) -->
<!-- 6. Make predictions on test dataset (Line 1668) -->
<!-- 7. Create AUC curves (Line 1722) -->
<!-- 8. Variable importance plots from gradient-boosted models (Line 1778) -->
<!-- 9. Create calibration plot in test dataset (Line 1839) -->
<!-- 10. Create facet plot of 50 point score at initial listing (Line 1887) -->
...
### US-CRS with balloon pumps in short-term MCS (no hemodynamics)
...
### US-CRS with balloon pumps in short-term MCS (with hemodynamics)
